...
namespace LimatamboAdmin.Controllers
{
    public class EspecialidadController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,nombre,imagen,imagenVector")] Especialidad especialidad)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,nombre,imagen,imagenVector")] Especialidad especialidad)
        {
            if (ModelState.IsValid)
            {
